...
class TestEaster(unittest.TestCase):
	...
	def test_paskha(self):
		self.assertEqual(cal.easter(2000, paskha=True), date(2000, 4, 30))
		self.assertEqual(cal.easter(2001, paskha=True), date(2001, 4, 15))
		self.assertEqual(cal.easter(2002, paskha=True), date(2002, 5, 5))
		self.assertEqual(cal.easter(2003, paskha=True), date(2003, 4, 27))
		self.assertEqual(cal.easter(2004, paskha=True), date(2004, 4, 11))
		self.assertEqual(cal.easter(2005, paskha=True), date(2005, 5, 1))
		self.assertEqual(cal.easter(2006, paskha=True), date(2006, 4, 23))
		self.assertEqual(cal.easter(2007, paskha=True), date(2007, 4, 8))
		self.assertEqual(cal.easter(2008, paskha=True), date(2008, 4, 27))
		self.assertEqual(cal.easter(2009, paskha=True), date(2009, 4, 19))
		self.assertEqual(cal.easter(2010, paskha=True), date(2010, 4, 4))
		self.assertEqual(cal.easter(2011, paskha=True), date(2011, 4, 24))
		self.assertEqual(cal.easter(2012, paskha=True), date(2012, 4, 15))
		self.assertEqual(cal.easter(2013, paskha=True), date(2013, 5, 5))
		self.assertEqual(cal.easter(2014, paskha=True), date(2014, 4, 20))
		self.assertEqual(cal.easter(2015, paskha=True), date(2015, 4, 12))
		self.assertEqual(cal.easter(2016, paskha=True), date(2016, 5, 1))
		self.assertEqual(cal.easter(2017, paskha=True), date(2017, 4, 16))
		self.assertEqual(cal.easter(2018, paskha=True), date(2018, 4, 8))
		self.assertEqual(cal.easter(2019, paskha=True), date(2019, 4, 28))
		self.assertEqual(cal.easter(2020, paskha=True), date(2020, 4, 19))
		self.assertEqual(cal.easter(2021, paskha=True), date(2021, 5, 2))
		self.assertEqual(cal.easter(2022, paskha=True), date(2022, 4, 24))
		self.assertEqual(cal.easter(2023, paskha=True), date(2023, 4, 16))
		self.assertEqual(cal.easter(2024, paskha=True), date(2024, 5, 5))
		self.assertEqual(cal.easter(2025, paskha=True), date(2025, 4, 20))
		self.assertEqual(cal.easter(2026, paskha=True), date(2026, 4, 12))
		self.assertEqual(cal.easter(2027, paskha=True), date(2027, 5, 2))
		self.assertEqual(cal.easter(2028, paskha=True), date(2028, 4, 16))
		self.assertEqual(cal.easter(2029, paskha=True), date(2029, 4, 8))
		self.assertEqual(cal.easter(2030, paskha=True), date(2030, 4, 28))
